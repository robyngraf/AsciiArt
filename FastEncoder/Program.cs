...
for (int y = 0; y < height - 7; y += 8)
{
    for (int x = 0; x < width - 6; x += 7)
    {
        ...
        float count1 = 0; // Region 1: X = 0, Y = 0, Width = 5, Height = 5, Size = 25
        float count2 = 0; // Region 2: X = 1, Y = 2, Width = 5, Height = 4, Size = 20
        float count3 = 0; // Region 3: X = 2, Y = 0, Width = 3, Height = 3, Size = 9
        float count4 = 0; // Region 4: X = 2, Y = 5, Width = 3, Height = 3, Size = 9
        float count5 = 0; // Region 5: X = 0, Y = 0, Width = 3, Height = 3, Size = 9
        float count6 = 0; // Region 6: X = 4, Y = 0, Width = 3, Height = 3, Size = 9
        float count7 = 0; // Region 7: X = 0, Y = 5, Width = 3, Height = 3, Size = 9
        float count8 = 0; // Region 8: X = 0, Y = 2, Width = 2, Height = 4, Size = 8
        float count9 = 0; // Region 9: X = 5, Y = 2, Width = 2, Height = 4, Size = 8
        float brightness;
        brightness = sourceImage[x, y].GetLinearBrightness();
        count0 += brightness; // Pixel 0, 0 is in region 0.
        count1 += brightness; // Pixel 0, 0 is in region 1.
        count5 += brightness; // Pixel 0, 0 is in region 5.
        brightness = sourceImage[x + 1, y].GetLinearBrightness();
        count0 += brightness; // Pixel 1, 0 is in region 0.
        count1 += brightness; // Pixel 1, 0 is in region 1.
        count5 += brightness; // Pixel 1, 0 is in region 5.
        brightness = sourceImage[x + 2, y].GetLinearBrightness();
        count0 += brightness; // Pixel 2, 0 is in region 0.
        count1 += brightness; // Pixel 2, 0 is in region 1.
        count3 += brightness; // Pixel 2, 0 is in region 3.
        count5 += brightness; // Pixel 2, 0 is in region 5.
        brightness = sourceImage[x + 3, y].GetLinearBrightness();
        count0 += brightness; // Pixel 3, 0 is in region 0.
        count1 += brightness; // Pixel 3, 0 is in region 1.
        count3 += brightness; // Pixel 3, 0 is in region 3.
        brightness = sourceImage[x + 4, y].GetLinearBrightness();
        count0 += brightness; // Pixel 4, 0 is in region 0.
        count1 += brightness; // Pixel 4, 0 is in region 1.
        count3 += brightness; // Pixel 4, 0 is in region 3.
        count6 += brightness; // Pixel 4, 0 is in region 6.
        brightness = sourceImage[x + 5, y].GetLinearBrightness();
        count0 += brightness; // Pixel 5, 0 is in region 0.
        count6 += brightness; // Pixel 5, 0 is in region 6.
        brightness = sourceImage[x + 6, y].GetLinearBrightness();
        count0 += brightness; // Pixel 6, 0 is in region 0.
        count6 += brightness; // Pixel 6, 0 is in region 6.
        brightness = sourceImage[x, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 0, 1 is in region 0.
        count1 += brightness; // Pixel 0, 1 is in region 1.
        count5 += brightness; // Pixel 0, 1 is in region 5.
        brightness = sourceImage[x + 1, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 1, 1 is in region 0.
        count1 += brightness; // Pixel 1, 1 is in region 1.
        count5 += brightness; // Pixel 1, 1 is in region 5.
        brightness = sourceImage[x + 2, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 2, 1 is in region 0.
        count1 += brightness; // Pixel 2, 1 is in region 1.
        count3 += brightness; // Pixel 2, 1 is in region 3.
        count5 += brightness; // Pixel 2, 1 is in region 5.
        brightness = sourceImage[x + 3, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 3, 1 is in region 0.
        count1 += brightness; // Pixel 3, 1 is in region 1.
        count3 += brightness; // Pixel 3, 1 is in region 3.
        brightness = sourceImage[x + 4, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 4, 1 is in region 0.
        count1 += brightness; // Pixel 4, 1 is in region 1.
        count3 += brightness; // Pixel 4, 1 is in region 3.
        count6 += brightness; // Pixel 4, 1 is in region 6.
        brightness = sourceImage[x + 5, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 5, 1 is in region 0.
        count6 += brightness; // Pixel 5, 1 is in region 6.
        brightness = sourceImage[x + 6, y + 1].GetLinearBrightness();
        count0 += brightness; // Pixel 6, 1 is in region 0.
        count6 += brightness; // Pixel 6, 1 is in region 6.
        brightness = sourceImage[x, y + 2].GetLinearBrightness();
        count0 += brightness; // Pixel 0, 2 is in region 0.
        count1 += brightness; // Pixel 0, 2 is in region 1.
        count5 += brightness; // Pixel 0, 2 is in region 5.
        count8 += brightness; // Pixel 0, 2 is in region 8.
        ...
        count2 += brightness; // Pixel 1, 2 is in region 2.
        count5 += brightness; // Pixel 1, 2 is in region 5.
        count8 += brightness; // Pixel 1, 2 is in region 8.
        ...
        count3 += brightness; // Pixel 2, 2 is in region 3.
        count5 += brightness; // Pixel 2, 2 is in region 5.
        ...
        count3 += brightness; // Pixel 3, 2 is in region 3.
        ...
        count3 += brightness; // Pixel 4, 2 is in region 3.
        count6 += brightness; // Pixel 4, 2 is in region 6.
        brightness = sourceImage[x + 5, y + 2].GetLinearBrightness();
        count0 += brightness; // Pixel 5, 2 is in region 0.
        count2 += brightness; // Pixel 5, 2 is in region 2.
        count6 += brightness; // Pixel 5, 2 is in region 6.
        count9 += brightness; // Pixel 5, 2 is in region 9.
        brightness = sourceImage[x + 6, y + 2].GetLinearBrightness();
        count0 += brightness; // Pixel 6, 2 is in region 0.
        count6 += brightness; // Pixel 6, 2 is in region 6.
        count9 += brightness; // Pixel 6, 2 is in region 9.
        brightness = sourceImage[x, y + 3].GetLinearBrightness();
        count0 += brightness; // Pixel 0, 3 is in region 0.
        count1 += brightness; // Pixel 0, 3 is in region 1.
        count8 += brightness; // Pixel 0, 3 is in region 8.
        ...
        count2 += brightness; // Pixel 1, 3 is in region 2.
        count8 += brightness; // Pixel 1, 3 is in region 8.
        ...
        count2 += brightness; // Pixel 2, 3 is in region 2.
        ...
        count2 += brightness; // Pixel 3, 3 is in region 2.
        ...
        count2 += brightness; // Pixel 1, 4 is in region 2.
        count8 += brightness; // Pixel 1, 4 is in region 8.
        ...
        count2 += brightness; // Pixel 2, 4 is in region 2.
        ...
        count2 += brightness; // Pixel 3, 4 is in region 2.
        ...
        weight = (int)((count1 - 1) * 6f / 24f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        weight = (int)((count2 - 1) * 6f / 19f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        ...
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        weight = (int)((count6 - 1) * 6f / 8f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        weight = (int)((count7 - 1) * 6f / 8f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        weight = (int)((count8 - 1) * 6f / 7f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
        weight = (int)((count9 - 1) * 6f / 7f + 1);
        weight ^= xor;
        nodeIndex = nodes[nodeIndex * 8 + weight];
